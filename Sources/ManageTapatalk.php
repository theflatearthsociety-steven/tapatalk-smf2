...
function ManageTapatalkRebranding($return_config = false)
{
    ...
    $config_vars = array(
            array('text', 'tp_byo_app_id', 'value'=> isset($modSettings['tp_byo_app_id'])? $modSettings['tp_byo_app_id'] : ''),
            array('text', 'tp_byo_app_name', 'value'=> isset($modSettings['tp_byo_app_name'])? $modSettings['tp_byo_app_name'] : 'Tapatalk Forum App'),
            array('text', 'tp_byo_app_desc', 'value'=> isset($modSettings['tp_byo_app_desc'])? $modSettings['tp_byo_app_desc'] : 'App for this forum'),
            array('text', 'tp_byo_app_icon_url', 'value'=> isset($modSettings['tp_byo_app_icon_url'])? $modSettings['tp_byo_app_icon_url'] : ''),
            ...
            array('text', 'tp_android_hd_msg', 'value'=> isset($modSettings['tp_android_hd_msg'])? $modSettings['tp_android_hd_msg'] : 'This forum has an app for Android HD. Click OK to learn more about Tapatalk.' ,  'size' => '80'),
            array('text', 'tp_android_hd_url', 'value'=> isset($modSettings['tp_android_hd_url'])? $modSettings['tp_android_hd_url'] : 'market://details?id=com.quoord.tapatalkHD' ,  'size' => '80'),
